import React from 'react';
    ...
    function SkillExchangeForumMessage() {
      const navigate = useNavigate();

      const handlePrev = () => {
        navigate('/khazana/messages/achievement-badges');
      };

      const handleNext = () => {
        navigate('/khazana/messages/tech-news-feed');
      };
          ...
          <div className="container mx-auto px-4 py-8 text-center relative z-10">
            ...
            <div className="flex items-center justify-center flex-col">
              <h2 className="text-5xl font-bold mb-6 relative before:absolute before:bottom-0 before:left-1/2 before:-translate-x-1/2 before:h-1 before:w-24 before:bg-blue-500 before:rounded">
                Skill Exchange Forum Unveiled!
              </h2>
              <p className="text-gray-300 text-xl mb-8">
                Offer your skills and request help from others in the community. This feature will create a platform for students to share their skills and help each other, fostering a collaborative learning environment.
              </p>
    ...
    export default SkillExchangeForumMessage;
