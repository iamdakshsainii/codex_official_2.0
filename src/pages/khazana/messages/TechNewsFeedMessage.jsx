import React from 'react';
    ...
    function TechNewsFeedMessage() {
      ...
      const handleNext = () => {
        navigate('/khazana/messages/daily-challenge-widget');
      };
          ...
          <div className="container mx-auto px-4 py-8 text-center relative z-10">
            ...
            <div className="flex items-center justify-center flex-col">
              <h2 className="text-5xl font-bold mb-6 relative before:absolute before:bottom-0 before:left-1/2 before:-translate-x-1/2 before:h-1 before:w-24 before:bg-blue-500 before:rounded">
                Tech News Feed Unveiled!
              </h2>
              <p className="text-gray-300 text-xl mb-8">
                Stay updated with the latest tech news and articles. This feature will provide you with a curated feed of relevant tech news and articles, keeping you informed about the latest trends and developments.
              </p>
    ...
    export default TechNewsFeedMessage;
