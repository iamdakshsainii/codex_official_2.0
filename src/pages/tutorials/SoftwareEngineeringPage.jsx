    ...
    const topics = [
      {
        ...
        content: 'This is the introduction to software engineering. Learn about the basic concepts and importance of software development.',
      },
      {
        ...
        subtopics: [
          {
            ...
            content: 'Explore the waterfall model and its phases.',
          },
          {
            title: 'Agile Model',
            content: 'Learn about the agile methodology and its principles.',
          },
        ],
      },
      {
        title: 'Requirements Engineering',
        content: 'Understand the process of gathering and documenting software requirements.',
      },
      {
        ...
        subtopics: [
          {
            ...
            content: 'Learn about different software architectural patterns.',
          },
          {
            title: 'Detailed Design',
            content: 'Explore the process of creating detailed design specifications.',
          },
        ],
      },
      {
        ...
        subtopics: [
          {
            title: 'Unit Testing',
            content: 'Understand the importance of unit testing and its implementation.',
          },
          {
            title: 'Integration Testing',
            content: 'Explore integration testing and its role in software quality.',
          },
        ],
      },
      {
        title: 'Software Maintenance',
        content: 'Learn about software maintenance and its different types.',
      },
    ];

    function SoftwareEngineeringPage() {
      const [activeTopic, setActiveTopic] = useState('Introduction to Software Engineering');
