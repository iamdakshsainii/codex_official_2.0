import React, { useState } from 'react';
    ...
    function RequestNotesSection() {
      ...
      const handleRequestSubmit = (e) => {
        e.preventDefault();
        const mailtoLink = `mailto:codexnetwork8@gmail.com?subject=Study Material Request&body=Name: ${encodeURIComponent(requestName)}%0AEmail: ${encodeURIComponent(requestEmail)}%0ADetails: ${encodeURIComponent(requestDetails)}`;
      ...
      return (
        <section id="request-notes" className="container mx-auto px-4 mb-16 text-center">
          <h2 className="text-2xl font-semibold mb-4">
            Can't find the notes you need?
          </h2>
          <p className="text-gray-400 mb-6">
            Request specific notes, and we'll do our best to help!
          </p>
          <button
          ...
          {isRequestFormVisible && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
              <div className="bg-gray-800 p-8 rounded-lg max-w-md w-full">
                <h3 className="text-2xl font-semibold text-center mb-4">Request Notes</h3>
                <p className="text-gray-400 text-center mb-4">
                  Please provide your details and the notes you are looking for.
                </p>
    ...
    export default RequestNotesSection;
